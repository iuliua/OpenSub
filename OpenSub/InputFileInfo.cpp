...
//|                                                                  |
//+------------------------------------------------------------------+
InputFileInfo::InputFileInfo(LPCWSTR file_name)
  {
   file_directory[0]=0;
   file_name_no_extension[0]=0;
   file_hash[0]=0;
   file_size[0]=0;
   wcscpy_s(this->file_full_name,sizeof(this->file_full_name)/sizeof(WCHAR),file_name);
   file_name_total=wcslen(file_name);
